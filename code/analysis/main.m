...
sessions = {'training1','decoding1','training2','decoding2'}
plotERPcomparison(data.e14, cfg, subjectID, figpath, sessions)
%%
sessions = {'validation1','validation2'}
plotERPcomparison(data.e13, cfg, subjectID, figpath, sessions)
